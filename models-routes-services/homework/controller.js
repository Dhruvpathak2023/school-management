...
class homeworkController {
    ...
    async addHomework(req,res) {
		try{
			var homework_url = await awsHelper.uploadImagefromBackendtoAWS(req.files.homework_image)
			
            req.body = pick(req.body, ['title', 'description', 'classId', 'subject', 'homework_name'])
			req.body.homework_url = homework_url
	...
	async updateHomework(req,res) {
		try{
            req.body = pick(req.body, ['title', 'description', 'classId', 'subject','homework_name'])
			if(req.files.homework_image)
                req.body.homework_url = await awsHelper.uploadImagefromBackendtoAWS(req.files.homework_image)
