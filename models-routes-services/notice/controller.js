...
class noticeController{
    ...
    async addNotice(req,res) {
		try{
			var notice_url = await awsHelper.uploadImagefromBackendtoAWS(req.files.notice_image)
			req.body.notice_url = notice_url
	...
	async update(req,res) {
		try{
			...
			if(req.files.notice_image)
                req.body.notice_url = await awsHelper.uploadImagefromBackendtoAWS(req.files.notice_image)
